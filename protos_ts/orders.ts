...
export interface PostOrderRequest {
     ...
     */
    price?: Quotation; // Цена одного инструмента. Для получения стоимости лота требуется умножить на лотность инструмента.
    /**
...
class OrderTrades$Type extends MessageType<OrderTrades> {
    ...
    create(value?: PartialMessage<OrderTrades>): OrderTrades {
        const message = { orderId: "", direction: 0, figi: "", trades: [], accountId: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
