...
export interface OrderTrades {
     ...
     */
    direction: OrderDirection; // Направление сделки (возможные значения)
    /**
...
export interface OrderTrade {
     ...
     */
    price?: Quotation; // Цена, по которой совершена сделка
    /**
     * @generated from protobuf field: int64 quantity = 3;
     */
    quantity: bigint; // Количество лотов в сделке
}
/**
...
export interface PostOrderResponse {
     ...
     */
    initialSecurityPrice?: MoneyValue; // Начальная цена инструмента заявки.
    /**
...
export interface OrderState {
     ...
     * @generated from protobuf field: tinkoff.public.invest.api.contract.v1.MoneyValue initial_security_price = 13;
     */
    initialSecurityPrice?: MoneyValue; // Начальная цена инструмента. Цена инструмента на момент выставления заявки.
    /**
...
class OrderTrades$Type extends MessageType<OrderTrades> {
    ...
    create(value?: PartialMessage<OrderTrades>): OrderTrades {
        const message = { orderId: "", direction: 0, figi: "", trades: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class PostOrderRequest$Type extends MessageType<PostOrderRequest> {
    ...
    create(value?: PartialMessage<PostOrderRequest>): PostOrderRequest {
        const message = { figi: "", quantity: 0n, direction: 0, accountId: "", orderType: 0, orderId: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class PostOrderResponse$Type extends MessageType<PostOrderResponse> {
    ...
    create(value?: PartialMessage<PostOrderResponse>): PostOrderResponse {
        const message = { orderId: "", executionReportStatus: 0, lotsRequested: 0n, lotsExecuted: 0n, figi: "", direction: 0, orderType: 0, message: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class OrderState$Type extends MessageType<OrderState> {
    ...
    create(value?: PartialMessage<OrderState>): OrderState {
        const message = { orderId: "", executionReportStatus: 0, lotsRequested: 0n, lotsExecuted: 0n, figi: "", direction: 0, stages: [], currency: "", orderType: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
