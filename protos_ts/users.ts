...
export interface GetInfoResponse {
     ...
     */
    qualifiedForWorkWith: string[]; // Набор требующих тестирования инструментов и возможностей, с которыми может работать пользователь.
}
/**
 * Тип счёта.
 *
...
class GetInfoResponse$Type extends MessageType<GetInfoResponse> {
    ...
    create(value?: PartialMessage<GetInfoResponse>): GetInfoResponse {
        const message = { premStatus: false, qualStatus: false, qualifiedForWorkWith: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
