...
export interface Coupon {
     ...
     */
    couponNumber: bigint; // Номер купона
    /**
...
class Coupon$Type extends MessageType<Coupon> {
    constructor() {
        super("tinkoff.public.invest.api.contract.v1.Coupon", [
            ...
            { no: 3, name: "coupon_number", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
    ...
    create(value?: PartialMessage<Coupon>): Coupon {
        const message = { figi: "", couponNumber: 0n, couponType: 0, couponPeriod: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 coupon_number */ 3:
                    message.couponNumber = reader.int64().toBigInt();
                    break;
...
class Bond$Type extends MessageType<Bond> {
    ...
    create(value?: PartialMessage<Bond>): Bond {
        const message = { figi: "", ticker: "", classCode: "", isin: "", lot: 0, currency: "", shortEnabledFlag: false, name: "", exchange: "", couponQuantityPerYear: 0, countryOfRisk: "", countryOfRiskName: "", sector: "", issueKind: "", issueSize: 0n, issueSizePlan: 0n, tradingStatus: 0, otcFlag: false, buyAvailableFlag: false, sellAvailableFlag: false, floatingCouponFlag: false, perpetualFlag: false, amortizationFlag: false, apiTradeAvailableFlag: false, uid: "", realExchange: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class Currency$Type extends MessageType<Currency> {
    ...
    create(value?: PartialMessage<Currency>): Currency {
        const message = { figi: "", ticker: "", classCode: "", isin: "", lot: 0, currency: "", shortEnabledFlag: false, name: "", exchange: "", countryOfRisk: "", countryOfRiskName: "", tradingStatus: 0, otcFlag: false, buyAvailableFlag: false, sellAvailableFlag: false, isoCurrencyName: "", apiTradeAvailableFlag: false, uid: "", realExchange: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class Etf$Type extends MessageType<Etf> {
    ...
    create(value?: PartialMessage<Etf>): Etf {
        const message = { figi: "", ticker: "", classCode: "", isin: "", lot: 0, currency: "", shortEnabledFlag: false, name: "", exchange: "", focusType: "", countryOfRisk: "", countryOfRiskName: "", sector: "", rebalancingFreq: "", tradingStatus: 0, otcFlag: false, buyAvailableFlag: false, sellAvailableFlag: false, apiTradeAvailableFlag: false, uid: "", realExchange: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class Future$Type extends MessageType<Future> {
    ...
    create(value?: PartialMessage<Future>): Future {
        const message = { figi: "", ticker: "", classCode: "", lot: 0, currency: "", shortEnabledFlag: false, name: "", exchange: "", futuresType: "", assetType: "", basicAsset: "", countryOfRisk: "", countryOfRiskName: "", sector: "", tradingStatus: 0, otcFlag: false, buyAvailableFlag: false, sellAvailableFlag: false, apiTradeAvailableFlag: false, uid: "", realExchange: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class Share$Type extends MessageType<Share> {
    ...
    create(value?: PartialMessage<Share>): Share {
        const message = { figi: "", ticker: "", classCode: "", isin: "", lot: 0, currency: "", shortEnabledFlag: false, name: "", exchange: "", issueSize: 0n, countryOfRisk: "", countryOfRiskName: "", sector: "", issueSizePlan: 0n, tradingStatus: 0, otcFlag: false, buyAvailableFlag: false, sellAvailableFlag: false, divYieldFlag: false, shareType: 0, apiTradeAvailableFlag: false, uid: "", realExchange: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class Instrument$Type extends MessageType<Instrument> {
    ...
    create(value?: PartialMessage<Instrument>): Instrument {
        const message = { figi: "", ticker: "", classCode: "", isin: "", lot: 0, currency: "", shortEnabledFlag: false, name: "", exchange: "", countryOfRisk: "", countryOfRiskName: "", instrumentType: "", tradingStatus: 0, otcFlag: false, buyAvailableFlag: false, sellAvailableFlag: false, apiTradeAvailableFlag: false, uid: "", realExchange: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class AssetSecurity$Type extends MessageType<AssetSecurity> {
    ...
    create(value?: PartialMessage<AssetSecurity>): AssetSecurity {
        const message = { isin: "", type: "", ext: { oneofKind: undefined } };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class AssetInstrument$Type extends MessageType<AssetInstrument> {
    ...
    create(value?: PartialMessage<AssetInstrument>): AssetInstrument {
        const message = { uid: "", figi: "", instrumentType: "", ticker: "", classCode: "", links: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class FavoriteInstrument$Type extends MessageType<FavoriteInstrument> {
    ...
    create(value?: PartialMessage<FavoriteInstrument>): FavoriteInstrument {
        const message = { figi: "", ticker: "", classCode: "", isin: "", instrumentType: "", otcFlag: false, apiTradeAvailableFlag: false };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
