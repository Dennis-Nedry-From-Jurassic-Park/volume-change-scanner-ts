...
export interface MarketDataRequest {
    ...
    payload: {
         ...
         */
        subscribeLastPriceRequest: SubscribeLastPriceRequest; // Запрос подписки на последние цены.
    } | {
        oneofKind: undefined;
    };
}
...
export interface MarketDataResponse {
    ...
    payload: {
         ...
         */
        subscribeLastPriceResponse: SubscribeLastPriceResponse; // Результат подписки на последние цены инструментов.
    } | {
        oneofKind: "lastPrice";
        /**
         * @generated from protobuf field: tinkoff.public.invest.api.contract.v1.LastPrice last_price = 11;
         */
        lastPrice: LastPrice; // Последняя цена.
    } | {
        oneofKind: undefined;
    };
}
...
export interface SubscribeLastPriceRequest {
     ...
     */
    instruments: LastPriceInstrument[]; // Массив инструментов для подписки на последнюю цену.
}
/**
...
export interface SubscribeLastPriceResponse {
     ...
     */
    lastPriceSubscriptions: LastPriceSubscription[]; // Массив статусов подписки на последнюю цену.
}
/**
...
export interface Candle {
     ...
     */
    volume: bigint; // Объём сделок в лотах.
    /**
...
export interface OrderBook {
     ...
     */
    limitUp?: Quotation; // Верхний лимит цены за 1 инструмент. Для получения стоимости лота требуется умножить на лотность инструмента.
    /**
     * @generated from protobuf field: tinkoff.public.invest.api.contract.v1.Quotation limit_down = 8;
     */
    limitDown?: Quotation; // Нижний лимит цены за 1 инструмент. Для получения стоимости лота требуется умножить на лотность инструмента.
}
/**
...
export interface Order {
     ...
     */
    quantity: bigint; // Количество в лотах.
}
/**
 * Информация о сделке.
 *
...
export interface HistoricCandle {
     ...
     */
    volume: bigint; // Объём торгов в лотах.
    /**
     * @generated from protobuf field: google.protobuf.Timestamp time = 6;
     */
...
export interface GetLastPricesResponse {
     ...
     */
    lastPrices: LastPrice[]; // Массив последних цен.
}
/**
 * Информация о цене.
 *
...
export interface GetOrderBookResponse {
     ...
     */
    lastPrice?: Quotation; // Цена последней сделки за 1 инструмент. Для получения стоимости лота требуется умножить на лотность инструмента.
    /**
     * @generated from protobuf field: tinkoff.public.invest.api.contract.v1.Quotation close_price = 6;
     */
    closePrice?: Quotation; // Цена закрытия за 1 инструмент. Для получения стоимости лота требуется умножить на лотность инструмента.
    /**
     * @generated from protobuf field: tinkoff.public.invest.api.contract.v1.Quotation limit_up = 7;
     */
    limitUp?: Quotation; // Верхний лимит цены за 1 инструмент. Для получения стоимости лота требуется умножить на лотность инструмента.
...
class CandleSubscription$Type extends MessageType<CandleSubscription> {
    ...
    create(value?: PartialMessage<CandleSubscription>): CandleSubscription {
        const message = { figi: "", interval: 0, subscriptionStatus: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class OrderBookSubscription$Type extends MessageType<OrderBookSubscription> {
    ...
    create(value?: PartialMessage<OrderBookSubscription>): OrderBookSubscription {
        const message = { figi: "", depth: 0, subscriptionStatus: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class TradeSubscription$Type extends MessageType<TradeSubscription> {
    ...
    create(value?: PartialMessage<TradeSubscription>): TradeSubscription {
        const message = { figi: "", subscriptionStatus: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class Candle$Type extends MessageType<Candle> {
    constructor() {
        super("tinkoff.public.invest.api.contract.v1.Candle", [
            ...
            { no: 7, name: "volume", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
    ...
    create(value?: PartialMessage<Candle>): Candle {
        const message = { figi: "", interval: 0, volume: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class OrderBook$Type extends MessageType<OrderBook> {
    ...
    create(value?: PartialMessage<OrderBook>): OrderBook {
        const message = { figi: "", depth: 0, isConsistent: false, bids: [], asks: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class Trade$Type extends MessageType<Trade> {
    ...
    create(value?: PartialMessage<Trade>): Trade {
        const message = { figi: "", direction: 0, quantity: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class TradingStatus$Type extends MessageType<TradingStatus> {
    ...
    create(value?: PartialMessage<TradingStatus>): TradingStatus {
        const message = { figi: "", tradingStatus: 0, limitOrderAvailableFlag: false, marketOrderAvailableFlag: false };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class GetOrderBookResponse$Type extends MessageType<GetOrderBookResponse> {
    ...
    create(value?: PartialMessage<GetOrderBookResponse>): GetOrderBookResponse {
        const message = { figi: "", depth: 0, bids: [], asks: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class GetTradingStatusResponse$Type extends MessageType<GetTradingStatusResponse> {
    ...
    create(value?: PartialMessage<GetTradingStatusResponse>): GetTradingStatusResponse {
        const message = { figi: "", tradingStatus: 0, limitOrderAvailableFlag: false, marketOrderAvailableFlag: false, apiTradeAvailableFlag: false };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
