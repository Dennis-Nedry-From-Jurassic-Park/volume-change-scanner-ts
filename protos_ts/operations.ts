...
export interface PortfolioPosition {
     ...
     */
    expectedYield?: Quotation; // Текущая рассчитанная относительная доходность позиции, в %.
    /**
     ...
     */
    averagePositionPricePt?: Quotation; // Средняя цена лота в позиции в пунктах (для фьючерсов). **Возможна задержка до секунды для пересчёта**.
    /**
...
class Operation$Type extends MessageType<Operation> {
    ...
    create(value?: PartialMessage<Operation>): Operation {
        const message = { id: "", parentOperationId: "", currency: "", state: 0, quantity: 0n, quantityRest: 0n, figi: "", instrumentType: "", type: "", operationType: 0, trades: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
